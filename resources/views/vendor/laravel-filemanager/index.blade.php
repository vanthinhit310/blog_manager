...
@endpush
@section('content')
    <nav class="navbar file-manager-tool navbar-horizontal navbar-expand-lg navbar-dark bg-default" id="nav">
        ...
        <div class="collapse navbar-collapse flex-grow-0" id="nav-buttons">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" id="dropdownMenuButton" role="button" aria-haspopup="true" aria-expanded="false">
    ...
    <nav class="bg-default file-manager-tool fixed-bottom border-top d-none" id="actions">
        <a class="action-custom" data-action="open" data-multiple="false"><i class="fas fa-folder-open"></i>{{ trans('laravel-filemanager::lfm.btn-open') }}</a>
        <a data-action="preview" class="action-custom" data-multiple="true"><i class="fas fa-images"></i>{{ trans('laravel-filemanager::lfm.menu-view') }}</a>
        <a data-action="use" class="action-custom" data-multiple="true"><i class="fas fa-check"></i>{{ trans('laravel-filemanager::lfm.btn-confirm') }}</a>
    </nav>
